...
# How to use?
 ...
 - by manually parsing the inputs using the file *Fuzzy_heating_rules.ipynb*
 - having the inputs coming from the sensor and the interactive interface using the set up in the folder *FuzzyprogWebSensor*

 ### Manual simulation
Done by changing these values in the before last cell of *Fuzzy_heating_rules.ipynb*
 ```
